...
public class Orders {
	...
	public Orders(int i, String string, double d, int j, String string2, String string3, int k, int l, String string4,
			String string5, String string6, String string7, String string8, int m) {
